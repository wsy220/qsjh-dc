var checkUrl = "/api/version/getnewversion/dc";
...
//			console.log(JSON.stringify(data.obj))
						...
						if(forceUpdate && forceUpdate == "Y") {
							mui.alert('请确认更新应用版本' + newVer, '版本更新', function() {
								if(plus.os.name == "Android") {
									...
									plus.runtime.openURL("https://itunes.apple.com/cn/app/70%E4%BD%B3%E6%8A%A4-%E5%8C%BB%E6%8A%A4%E7%AB%AF/id1376380934?mt=8");
								}
							});
						} else {
							var btnArray = ['否', '是'];
	...
	commonHttpUtils(url, "get", {}, sussess, function() {
		plus.nativeUI.closeWaiting();
	}, function() {});
}
